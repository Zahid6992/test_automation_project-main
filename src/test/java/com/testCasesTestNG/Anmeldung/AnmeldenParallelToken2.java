...
public class AnmeldenParallelToken2 extends DriverTestCase  {
    ...
    public void anmelden(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException, IOException {
        ...
        Date date = new Date();
        System.out.println("TC2 Start" + new Timestamp(date.getTime()));
        Thread.sleep(1500000);
        driver.navigate().refresh();
        Date date2 = new Date();
        System.out.println("TC2 End" + new Timestamp(date2.getTime()));
        Thread.sleep(6000);
    }
