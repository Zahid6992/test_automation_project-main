...
public class Damen_C_Zufaelligebuchstaben_Fehlerseiten_Tests extends DriverTestCase {
    ...
    @Test()
    public void Test_Step_01_damen_c_zufaelligeBuchstaben_check_url(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException, IOException {
        ...
        extentReportConfig.configureExtentReportBeforeTest("TF06 - Fehlerseiten Tests - Damen-C-Zufaellige Buchstaben", mobileOrDesktop, deviceName, shop, environment);
    ...
    @Parameters({"mobileOrDesktop", "deviceName", "shop", "environment"})
    @Test(dependsOnMethods = "Test_Step_01_damen_c_zufaelligeBuchstaben_check_url", alwaysRun=true)
    public void Test_Step_02_damen_c_zufaelligeBuchstaben_check_not_found_message(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException {
    ...
    @Parameters({"mobileOrDesktop", "deviceName", "shop", "environment"})
    @Test(dependsOnMethods = "Test_Step_02_damen_c_zufaelligeBuchstaben_check_not_found_message", alwaysRun=true)
    public void Test_Step_03_damen_c_zufaelligeBuchstaben_check_404_Response_Code(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException {
        extentReportConfig.configureExtentReportTestInfo("-----------------------------------------");
    ...
    @Parameters({"mobileOrDesktop", "deviceName", "shop", "environment"})
    @Test(dependsOnMethods = "Test_Step_03_damen_c_zufaelligeBuchstaben_check_404_Response_Code", alwaysRun=true)
    public void Test_Step_04_damen_c_zufaelligeBuchstaben_check_404_Response_Code(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException {
        extentReportConfig.configureExtentReportTestInfo("-----------------------------------------");
