...
public class Fehlerseiten_Damen_C_Zufaelligebuchstaben extends DriverTestCase {
    ...
    @Test()
    public void damen_c_zufaelligeBuchstaben(String mobileOrDesktop, String deviceName, String shop, String environment) throws InterruptedException, IOException {

        String testCaseName = "Fehlerseiten_Damen_C_Zufaelligebuchstaben"  + "_"  + mobileOrDesktop + "_"  + shop + "_"  + environment ;
        extentReportConfig.configureExtentReportBeforeTest(testCaseName, mobileOrDesktop, deviceName, shop, environment);

        //Check 404 URL
        driver.get(urlMap.get(shop + " " + environment) + "/Damen/c-zueflligebuchstaben");
        Thread.sleep(3000);
