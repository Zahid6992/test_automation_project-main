package com.testCasesTestNG.Filter;
...
public class Filter extends DriverTestCase {
    ...
    public void searchTest(String mobileOrDesktop, String deviceName) throws InterruptedException {
    ...
    public void addArtikelToWunschList(String mobileOrDesktop, String deviceName, String shop, String environment)  {
